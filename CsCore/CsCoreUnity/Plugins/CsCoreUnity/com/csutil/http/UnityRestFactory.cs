...
namespace com.csutil.http {
    ...
    public class UnityRestFactory : RestFactory {
        ...
        public override Task<long> GetCurrentPing(string ipOrUrl = DEFAULT_PING_IP, int timeoutInMs = 1000) {
        ...
        public Task<long> GetCurrentPingViaHeadRequest(string ipOrUrl = DEFAULT_PING_IP, int timeoutInMs = 1000) {
