...
namespace com.csutil.src.Plugins.CsCore.com.csutil.algorithms {
    ...
    public class AaaaImageCompareAaaa {
        ...
        public CompareResult ImageCompare(ImageResult img1, ImageResult img2, double redScale=5) {
            ...
            result.distortion = GetMeanSquaredDistortion(colors_img1, colors_img2, resultImage, redScale);
            result.resultImage = resultImage;
        ...
        private double GetMeanSquaredDistortion(Color[] colors_img1, Color[] colors_img2, ImageResult resultImage, double redScale) {
            ...
            for (int i = 0; i < colors_img1.Length; i++) {
                ...
                if (colors_img1[i] != colors_img2[i]) {
                    ...
                    int red = (int)Math.Max(0, Math.Min(255, colors_img1[i].R * redScale * ratio + colors_img1[i].R));
            ...
            return squaredMeanSum / (colors_img1.Length);
