...
namespace com.csutil.tests.json {
    ...
    public class PersistedRegressionTests {
        ...
        public async Task ExampleUsage1() {
            ...
            MyClass1 myState = new MyClass1() {
                myName = "abc",
                myChildren = new MyClass1[] {
                    new MyClass1() {  myName = "def" }
                }
            };
            // The regression test wants ensure that this state does never change

            // The passed myState will be compared to the persisted regression entry stored on disk:
            await new PersistedRegression().AssertDiff("PersistedRegressionTests_ExampleUsage1_1", myState);
        ...
        public async Task ExampleUsage2() {
            ...
            await new PersistedRegression().AssertDiff("PersistedRegressionTests_ExampleUsage2_1", (diff) => {
